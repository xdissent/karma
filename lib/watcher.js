...
exports.watch = function(patterns, excludes, fileList, usePolling, globalEmitter) {
  ...
  globalEmitter.on('exit', function() {
...
exports.watch.$inject = ['config.files', 'config.exclude', 'fileList', 'config.usePolling', 'globalEmitter'];
